...
VALUES ('c08312ed-b5d9-48f9-8eb1-b966faa00f3e', 'oidc', 'custom:dc6c374d-51bc-434c-8edb-8f6b8c2231c6', 'Google',
        (select s.decrypted_secret from vault.decrypted_secrets s where s.name = 'google_oauth_client_id'),
        (select s.decrypted_secret from vault.decrypted_secrets s where s.name = 'google_oauth_client_secret'), ARRAY ['124781446178-h5qrasikq30um1fpk7fs4a9m97cvbeg7.apps.googleusercontent.com'], ARRAY ['openid','profile','email'], 'true', '{}', '{}', 'true',
