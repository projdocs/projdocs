...
begin
    ...
    IF ((TG_OP = 'INSERT' OR TG_OP = 'UPDATE') AND (NEW.bucket_id = ANY (ARRAY['company-public', 'company-private']))) OR (TG_OP = 'DELETE' AND (OLD.bucket_id = ANY (ARRAY['company-public', 'company-private']))) THEN
