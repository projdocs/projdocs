...
import { ArrowRight, CheckCircle2, Cloud, FileText, Plug, Server, ShieldCheck, Users } from "lucide-react";
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-background text-foreground">
      ...
      <footer className="border-t py-8">
        <div
          className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 text-sm text-muted-foreground sm:flex-row">
          <div className="flex items-center gap-2">
