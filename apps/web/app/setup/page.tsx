...
import { steps } from "@workspace/web/app/setup/steps";
import { AppRouterInstance } from "next/dist/shared/lib/app-router-context.shared-runtime";
import { useSetupProjDocsStore } from "@workspace/web/app/setup/store";
...
export default function Page() {
  ...
  const store = useSetupProjDocsStore();
  ...
  return (
    <div className={"flex flex-col w-full min-h-full overflow-scroll justify-center items-center p-4 py-12 gap-4"}>
      ...
      <div className={"flex flex-col items-center justify-center"}>
        ...
        <P>{"Configure ProDocs to continue"}</P>
      </div>
